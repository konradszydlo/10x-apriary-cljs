...
| 2 | Cross-feature regression guard | Prove summaries CSV import still works after products changes | #3 | Integration (summaries import) | complete | context/archive/2026-06-05-testing-cross-feature-regression |
| 3 | Security hardening | Verify RLS isolation and input sanitization | #4, #7 | Integration (multi-user RLS, XSS rendering) | change opened | context/changes/testing-security-hardening |
